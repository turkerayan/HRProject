...
{
    public class UpdateCompanyManagerValidator : AbstractValidator<UpdateCompanyManagerCommand>
    {
        public UpdateCompanyManagerValidator()
        {
            ...
            RuleFor(p => p.StartAJob)
                ...
                .GreaterThan(p => (DateTime)p.BirthDate.AddYears(18))
